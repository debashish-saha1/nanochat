...
# base training
python -m scripts.base_train --depth=4 --max-seq-len=512 --device-batch-size=1 --total-batch-size=1024 --eval-every=50 --eval-tokens=4096 --core-metric-every=50 --core-metric-max-per-task=12 --sample-every=50 --num-iterations=500 --model-tag=$MODEL_TAG
